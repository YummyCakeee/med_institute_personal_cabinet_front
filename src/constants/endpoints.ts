...
export const ENDPOINT_TEST_BLOCK_COLLECTIONS = "api/TestBlockCollections"
export const ENDPOINT_EDUCATION = "api/Education"
export const ENDPOINT_FILES = "api/Files"